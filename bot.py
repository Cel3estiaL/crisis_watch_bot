...
def main():
    ...
    reports = fetch_reports(
        ...
        report_formats=["Situation Report", "News and Press Release", "Analysis", "Assessment", "Map", "Infographic", "Intractive","Policy and Guidance", "Evaluation and Lessons Learned"]
    )
    #reports = fetch_reports(
     #   appname=Config.RELIEFWEB_APPNAME,
      #  limit=Config.FETCH_LIMIT,
